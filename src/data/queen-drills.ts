...
export const QUEEN_DRILL_SCENARIOS: QueenDrillScenario[] = [
  ...
  },
  {
    ...
    situation: "After 1.d4 d5 2.Nf3, Black played Qa5 — bringing the queen out to 'pressure' the queenside. It's not threatening anything real.",
    threat: "No real threat. The queen on a5 isn't doing anything productive. Just develop normally and it'll become a target later.",
    threatArrows: [],
    playerColor: "white",
    setupMoves: ["d4", "d5", "Nf3", "Qa5"],
    responses: [
      { san: "Nc3", quality: "best", feedback: "Nc3 develops naturally. The queen on a5 isn't threatening anything — don't chase it yet. You'll play Bd2 later to attack it with tempo.", continuation: ["e5", "e3"] },
      { san: "Bd2", quality: "good", feedback: "Bd2 develops and directly attacks the queen, but Nc3 first develops the knight to its best square. Knights before bishops — Nc3 is more natural." },
      { san: "c4", quality: "good", feedback: "c4 challenges the center and is fine, but Nc3 develops a piece. Pieces first, center pawns second." },
      { san: "a3", quality: "mistake", feedback: "a3 wastes a move. The queen isn't threatening anything! Just develop with Nc3 — the queen will become a target later naturally." },
      { san: "Qd3", quality: "mistake", feedback: "Don't bring YOUR queen out to match theirs! That's the same mistake you're trying to punish. Nc3 is strong and humble." },
    ],
    keyLesson: "When the opponent's queen is misplaced but not threatening, just develop normally. Don't waste time chasing it — it'll become a target on its own.",
  },
  {
  ...
  {
    id: "qh4-after-e5",
    name: "Black's ...Qh4: Annoying but weak",
    situation: "After 1.e4 e5 2.Nf3, Black played Qh4 — it looks scary because it targets both e4 and f2. But the queen is offside.",
    threat: "Qxe4+ would win the e4 pawn with check. Also eyeing f2 for future tricks.",
    threatArrows: [{ from: "h4", to: "e4" }, { from: "h4", to: "f2" }],
    playerColor: "white",
    setupMoves: ["e4", "e5", "Nf3", "Qh4"],
    responses: [
      { san: "Nc3", quality: "best", feedback: "Nc3 defends e4 AND develops. If Qxe4+?? then Be2 traps the queen in the center — it's actually dangerous for Black to grab the pawn. Just develop!", continuation: ["Bb4", "Be2"] },
      { san: "Be2", quality: "good", feedback: "Be2 develops the bishop and prepares castling. Solid, but Nc3 is slightly better because it defends e4 more aggressively." },
      { san: "g3", quality: "good", feedback: "g3 kicks the queen immediately but weakens your kingside structure. Nc3 defends e4 without any structural cost." },
      { san: "d3", quality: "mistake", feedback: "d3 defends e4 but blocks your bishop. Nc3 is much better — it develops a piece to its ideal square." },
      { san: "Nxe5", quality: "blunder", feedback: "Nxe5?? allows Qxe4+ forking your king and rook! Don't grab material when your king is exposed." },
    ],
    keyLesson: "Against ...Qh4, develop with Nc3 to defend e4. Don't grab the e5 pawn (Nxe5?? drops the rook to Qxe4+). Stay calm and develop.",
  },
  {
  ...
  },
  {
    ...
    situation: "After 1.d4 d5 2.c4 dxc4, Black plays Qa5+ trying to keep the c4 pawn. You need to block the check productively.",
    threat: "It's check! You must block, but HOW you block matters — block with a piece that develops AND attacks the queen.",
    threatArrows: [{ from: "a5", to: "e1" }],
    playerColor: "white",
    setupMoves: ["d4", "d5", "c4", "dxc4", "Qa5+"],
    responses: [
      { san: "Bd2", quality: "best", feedback: "Bd2 blocks the check, develops the bishop, AND attacks the queen on a5. Three purposes in one move! The queen will retreat and you play e3 + Bxc4.", continuation: ["Qd8", "e3"] },
      { san: "Nc3", quality: "good", feedback: "Nc3 blocks and develops, but the knight might be better placed elsewhere. Bd2 is more flexible and attacks the queen directly." },
      { san: "Nd2", quality: "good", feedback: "Nd2 blocks but the knight is passive there. Bd2 is better — the bishop actively attacks the queen." },
      { san: "Qd2", quality: "mistake", feedback: "Blocking with the queen allows Qxd2+ trading queens — you lose your initiative. Bd2 blocks without giving up anything." },
    ],
    keyLesson: "When checked by the queen, block with a piece that DEVELOPS and ATTACKS the queen at the same time. Bd2 is the classic multi-purpose block.",
  },
  {
    id: "caro-kann-qg4",
