...
export const kingsIndian: OpeningLine = {
  ...
  variants: [
    ...
    {
      id: "fianchetto-kid",
      name: "Fianchetto KID (4.Nf3 d6 5.g3)",
      description: "White plays Nf3 first then fianchettoes — quiet positional system.",
      branchesAt: 6,
      opponentMove: { san: "Nf3", color: "white", why: "White develops the knight before pushing e4.", concepts: ["development"] },
      moves: [
        { san: "d6", color: "black", why: "Standard KID.", concepts: ["pawn-structure"] },
        { san: "g3", color: "white", why: "Fianchetto setup.", concepts: ["development"] },
        { san: "O-O", color: "black", why: "Castle.", concepts: ["king-safety"] },
        { san: "Bg2", color: "white", why: "Complete fianchetto.", concepts: ["development"] },
        { san: "Nc6", color: "black", why: "Develop with active play.", concepts: ["development"] },
        { san: "O-O", color: "white", why: "Castle.", concepts: ["king-safety"] },
        { san: "e5", color: "black", why: "Freeing break.", concepts: ["attack"] },
      ],
    },
    {
      id: "averbakh-kid",
      name: "Averbakh KID (5.Be2 + Bg5)",
      description: "White plays Be2 instead of Nf3 then pins the knight with Bg5. Counter with ...c5.",
      branchesAt: 8,
      opponentMove: { san: "Be2", color: "white", why: "White plays Be2 (instead of Nf3) preparing Bg5.", concepts: ["development"] },
      moves: [
        { san: "O-O", color: "black", why: "Castle.", concepts: ["king-safety"] },
        { san: "Bg5", color: "white", why: "Averbakh — pin f6 knight.", concepts: ["attack"] },
        { san: "c5", color: "black", why: "Challenge the center.", concepts: ["attack"] },
        { san: "d5", color: "white", why: "Lock the center.", concepts: ["space"] },
        { san: "h6", color: "black", why: "Question the bishop.", concepts: ["attack"] },
      ],
    },
  ],
};
