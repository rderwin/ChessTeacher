...
export const italianGame: OpeningLine = {
  ...
  moves: [
    ...
    },
    {
      san: "Bxd2+",
      color: "black",
      why: "Black trades bishops, simplifying the position. After your knight recaptures, both sides have similar piece counts and the game continues with classical setups.",
      concepts: ["piece-activity"],
    },
    {
      san: "Nbxd2",
      color: "white",
      why: "Recapture with the queen-side knight (the one on b1). This keeps your developed Nf3 in place AND develops the second knight. Notice you must specify Nb-d2 because either knight could go there.",
      concepts: ["development"],
      controls: "Develops the queen-side knight",
      commonMistakes: [
        { san: "Qxd2", whyBad: "Recapturing with the queen brings the queen out too early and exposes it. Nbxd2 develops a piece — much better than wasting the queen on recapture." },
      ],
    },
    {
      san: "d5",
      color: "black",
      why: "Black plays the freeing pawn break ...d5! This is the key idea — Black challenges your e4 pawn before you can build up further. After exd5 Nxd5, the position is roughly equal.",
      concepts: ["center-control", "attack"],
    },
    {
      san: "exd5",
      color: "white",
      why: "Capture the pawn — you must, otherwise you lose e4. The position simplifies but you still have a slight edge from the open e-file and active pieces.",
      concepts: ["center-control"],
    },
    {
      san: "Nxd5",
      color: "black",
      why: "Black recaptures with the knight, putting it on a strong central square. The knight on d5 is well-placed and the position is balanced.",
      concepts: ["piece-activity", "center-control"],
    },
    {
      san: "O-O",
      color: "white",
      why: "Castle. Both sides will castle and reach a balanced middlegame with active pieces. You've successfully navigated the opening — now the middlegame begins.",
      concepts: ["king-safety"],
    },
    {
      san: "O-O",
      color: "black",
      why: "Black mirrors and castles too. Both kings are safe, opening theory is essentially over, and the early middlegame begins. The position is roughly balanced — White has a slightly more active piece setup, Black has solid central knights.",
      concepts: ["king-safety"],
      commonMistakes: [
        { san: "Bg4", whyBad: "Pinning the f3 knight against the queen looks tempting, but White can break the pin with h3 and gain tempo. Castle first — your king safety matters more than a speculative pin." },
        { san: "Nb6", whyBad: "Nb6 retreats your strong central knight to a passive square. Castle first to secure the king, then think about repositioning pieces." },
      ],
    },
    {
      san: "Re1",
      color: "white",
      why: "Rook to the open e-file! The e-file is wide open after the pawn exchanges, and your rook belongs there. This is rule one of rook play: open files belong to rooks. Re1 also keeps potential pressure on Black's position by eyeing through the e-file toward the king.",
      concepts: ["piece-activity", "development"],
      controls: "Open e-file",
      commonMistakes: [
        { san: "Nb3", whyBad: "Nb3 is a fine plan eventually, but rooks belong on open files. Always grab open files with rooks BEFORE rerouting knights — it's a bigger positional gain." },
        { san: "Qb3", whyBad: "Queen forays this early can backfire — Black just plays Na5 attacking both the queen and bishop. Develop the rook first to a great square, then think about queen activity." },
        { san: "a3", whyBad: "Prophylactic moves are fine but Re1 grabs the open file with tempo. Always claim open files when they're free — your opponent will take them otherwise." },
      ],
    },
    {
      san: "Bf5",
      color: "black",
      why: "Develop the last minor piece! Bf5 brings the c8 bishop into the game on a great diagonal, eyeing the kingside and supporting the d5 knight indirectly. Always finish development before launching attacks — every piece in the game means more options.",
      concepts: ["development", "piece-activity"],
      commonMistakes: [
        { san: "Re8", whyBad: "Re8 contesting the e-file is logical, but you still have an undeveloped bishop on c8! The rule: complete development first. After your bishop is out, then think about coordinating rooks." },
        { san: "Be6", whyBad: "Be6 develops the bishop but blocks your own e-file rook ideas and lets White trade bishops with Bxe6 (giving you doubled pawns). Bf5 is more active and avoids trades." },
        { san: "Nf4", whyBad: "Nf4 looks active but the knight isn't actually doing anything from f4 — it can be kicked by g3 or simply ignored. The c8 bishop is your worst-developed piece — it deserves attention first." },
      ],
    },
    {
      san: "Nb3",
      color: "white",
      why: "Reroute the knight from d2 (where it was awkward) to b3 (active square). The principle: improve your worst-placed piece. From b3 the knight eyes c5 (a great outpost), supports d4, and stays out of the way of your other pieces. This is positional chess at its purest — finding better squares.",
      concepts: ["piece-activity", "development"],
      controls: "c5 outpost, defends d4",
      commonMistakes: [
        { san: "Ne5", whyBad: "Ne5 is a decent maneuver but Black just plays Nxe5 dxe5 and now you have an isolated e-pawn instead of an isolated d-pawn — same problem, less control. Nb3 keeps the structure flexible." },
        { san: "h3", whyBad: "h3 (giving the king luft) is a useful move but timing matters. Improve your knight first — the d2 knight is doing nothing where it sits. Pieces > pawn moves when you have an obviously misplaced piece." },
        { san: "Bxd5", whyBad: "Trading the bishop for knight gives up the bishop pair! In open positions like this, two bishops are powerful long-range pieces. Never trade your bishop pair without good reason." },
      ],
    },
    {
      san: "Qd7",
      color: "black",
      why: "Connect the rooks and prepare to centralize them. Qd7 also defends b7 indirectly through the rook on a8 alignment, and prepares Rad8 to put both rooks on central files. With every piece coordinated, Black is fully developed and ready for the middlegame.",
      concepts: ["development", "preparation"],
      commonMistakes: [
        { san: "Re8", whyBad: "Re8 is fine but Qd7 first is more flexible — you can later put rooks on EITHER d8 or e8 depending on where pressure is needed. Develop the queen FIRST to connect the rooks." },
        { san: "Nxd4", whyBad: "Nxd4?? Nxd4 (white) and you've lost a knight for a pawn. Always count attackers and defenders before captures — d4 is defended by the f3 knight." },
        { san: "Qf6", whyBad: "Qf6 is too aggressive too soon — your queen gets exposed on f6 and can be hit by Bg5 (well, the bishop is gone but you get the idea — White can attack it). Qd7 is calmer and more solid." },
      ],
    },
    {
      san: "h3",
      color: "white",
      why: "Give the king luft — a tiny escape square so back-rank mate threats can't materialize. Also prevents Bg4 pins forever. This is prophylaxis: making preventive moves so your opponent has no tactics. It's a quiet move with long-term benefits.",
      concepts: ["king-safety", "prophylaxis"],
      controls: "g4 square",
      commonMistakes: [
        { san: "Qd3", whyBad: "Qd3 is good and we'll play it next, but h3 first prevents any Bg4 ideas (pinning your knight) and gives the king luft. Always handle latent threats before launching attacks." },
        { san: "Bxd5", whyBad: "Trading the bishop for the knight gives up the bishop pair. In semi-open positions like this, two bishops are powerful — don't trade them voluntarily without good reason." },
      ],
    },
    {
      san: "Rad8",
      color: "black",
      why: "Both rooks centralized! Rad8 puts the queen-side rook on the d-file (where the action is). The d-pawn is isolated and weak, so doubling rooks against d4 is the right plan. Rooks belong on open or semi-open files — and the d-file is exactly that.",
      concepts: ["piece-activity", "preparation"],
      controls: "d-file pressure",
      commonMistakes: [
        { san: "Rfd8", whyBad: "Rfd8 also goes to the d-file but the f8 rook is well placed (defending f7, supporting kingside). Move the LESS-actively-placed rook to the central file. Rad8 is more accurate." },
        { san: "Rfe8", whyBad: "Rfe8 fights for the e-file but the e-file is contested, while the d-file gives clear pressure on the isolated d4 pawn. Pick the file where you have a concrete target." },
      ],
    },
    {
      san: "Qd3",
      color: "white",
      why: "Centralize the queen, defend d4, and prepare Rad1 to fight for the d-file. From d3 the queen also has some attacking potential along the diagonal toward h7 if Black ever weakens the kingside. Active queen + pieces all developed = real middlegame play begins.",
      concepts: ["piece-activity", "preparation"],
      controls: "d-file, b1-h7 diagonal",
      commonMistakes: [
        { san: "Bxd5", whyBad: "Trading bishop for knight gives up the bishop pair AGAIN — and the resulting position offers nothing. Hold the bishop pair, especially in semi-open positions like this." },
        { san: "Ne5", whyBad: "Ne5 looks aggressive but Nxe5 dxe5 and now you have a backwards d-pawn... wait, you don't even have a d-pawn after that exchange. The point: Ne5 simplifies favorably for Black. Stay patient." },
      ],
    },
    {
      san: "Bg6",
      color: "black",
      why: "Step the bishop out of the queen's diagonal — Qd3 was eyeing your bishop on f5 along the b1-h7 diagonal. Bg6 is a great square: still active, defends f7 in some lines, and avoids trades. Notice the dance: each side responds to the other's threats while improving piece placement.",
      concepts: ["piece-activity", "prophylaxis"],
      commonMistakes: [
        { san: "Be6", whyBad: "Be6 is too passive — the bishop blocks your own e-file ideas and lets the white knight maneuver freely. Bg6 keeps the bishop active outside the e-file." },
        { san: "Qe6", whyBad: "Moving the queen away from d7 abandons the d-file plan you just built. Address White's threat (the queen on d3 attacking your bishop) by moving the bishop, not the queen." },
      ],
    },
    {
      san: "Rad1",
      color: "white",
      why: "All pieces optimally placed! Rad1 puts the second rook on the d-file, doubling pressure. Now the position is fully developed with a clear plan: pressure the IQP (isolated queen pawn structure) is balanced for both sides — White has active pieces and the bishop pair, Black has solid central knights and a target (the isolated d4 pawn). This is the modern Italian Game middlegame: maneuvering, accumulating tiny advantages, waiting for the right tactical moment. You've completed the opening AND the early middlegame setup. Welcome to real chess.",
      concepts: ["piece-activity", "preparation"],
      controls: "d-file fully contested",
      commonMistakes: [
        { san: "Bxd5", whyBad: "Last chance to NOT trade the bishop pair — and the answer is still no. The bishop on c4 is your most active piece, and giving it up for a centralized knight loses your long-term advantage." },
        { san: "Ne5", whyBad: "Ne5 still leads to simplifications that favor Black. Patience! Rad1 keeps the pressure and forces Black to defend accurately." },
      ],
    },
  ],
  summary:
  ...
  variants: [
    ...
    // ============================================================
    // DEEPER SUB-VARIANTS — sharp tactical lines and traps
    // ============================================================
    {
      id: "traxler-counter",
      name: "Two Knights — Traxler Counter (Wilkes-Barre)",
      description: "After 4.Ng5, Black plays the wild ...Bc5! sacrificing the bishop for kingside attack. Sharp tactical play — know the refutation.",
      branchesAt: 5,
      opponentMove: {
        san: "Nf6",
        color: "black",
        why: "Black plays Two Knights. Now you're heading into Ng5 territory — but Black might hit you with the wild Traxler!",
        concepts: ["development", "attack"],
      },
      moves: [
        { san: "Ng5", color: "white", why: "The sharp Two Knights line — attack f7. Now Black might play the calm d5 (main) or the WILD Traxler with Bc5.", concepts: ["attack"] },
        { san: "Bc5", color: "black", why: "The Traxler / Wilkes-Barre Counter Gambit! Black ignores the f7 threat and offers a piece sacrifice for a vicious attack. Sharpest move on the chessboard.", concepts: ["attack"] },
        {
          san: "Nxf7",
          color: "white",
          why: "Take the rook! Bxf7+ is also possible but Nxf7 is sharper. You're up an exchange, but Black has a furious attack coming. You must defend precisely.",
          concepts: ["attack"],
          commonMistakes: [
            { san: "Bxf7+", whyBad: "Bxf7+ is also playable (the 'classical' refutation) but Nxf7 is sharper and more critical. Both are theoretically sound." },
          ],
        },
        { san: "Bxf2+", color: "black", why: "Black sacrifices the bishop! After Kxf2 Black plays Nxe4+ unleashing a kingside attack.", concepts: ["attack"] },
        { san: "Kxf2", color: "white", why: "You must take. Kf1 also exists but Kxf2 is more critical. Be ready to defend.", concepts: ["king-safety"] },
        { san: "Nxe4+", color: "black", why: "Black continues the attack with check.", concepts: ["attack"] },
        { san: "Kg1", color: "white", why: "Run the king to the corner. Don't waste time — get out of the danger zone.", concepts: ["king-safety"] },
        { san: "Qh4", color: "black", why: "Black brings the queen to attack with maximum force.", concepts: ["attack"] },
        { san: "g3", color: "white", why: "Block the attack. The position is dangerous but defensible.", concepts: ["king-safety"] },
        { san: "Nxg3", color: "black", why: "Black continues sacrificing for the attack.", concepts: ["attack"] },
        { san: "hxg3", color: "white", why: "Take the knight. Now the attack runs out of fuel and you have a winning material advantage if you can survive.", concepts: ["king-safety"] },
        { san: "Qxg3+", color: "black", why: "Black gives one last check.", concepts: ["attack"] },
      ],
    },
    {
      id: "two-knights-d6",
      name: "Two Knights — Black plays passive ...d6",
      description: "After 4.Ng5, Black plays the passive ...d6 instead of the sharp d5. Punish with Nxf7 winning the exchange.",
      branchesAt: 5,
      opponentMove: {
        san: "Nf6",
        color: "black",
        why: "Black plays Two Knights, expecting Ng5.",
        concepts: ["development"],
      },
      moves: [
        { san: "Ng5", color: "white", why: "Attack f7.", concepts: ["attack"] },
        { san: "d6", color: "black", why: "Black plays passively trying to defend f7. But this allows Nxf7 winning the exchange — d5 was the only good move.", concepts: ["pawn-structure"] },
        { san: "Nxf7", color: "white", why: "Take! You win the rook on h8. Up the exchange = winning material.", concepts: ["attack"] },
        { san: "Qe7", color: "black", why: "Black has to deal with the knight on f7 attacking everything.", concepts: ["development"] },
        { san: "Nxh8", color: "white", why: "Take the rook. Up an exchange.", concepts: ["attack"] },
        { san: "Nxe4", color: "black", why: "Black grabs a pawn for some compensation.", concepts: ["attack"] },
        { san: "O-O", color: "white", why: "Castle. You're up an exchange — just survive and convert.", concepts: ["king-safety"] },
        { san: "Nf6", color: "black", why: "Black retreats the knight.", concepts: ["development"] },
        { san: "d3", color: "white", why: "Solidify and prepare to bring the trapped knight back.", concepts: ["development"] },
      ],
    },
    {
      id: "evans-declined",
      name: "Evans Gambit — Black declines with ...Bb6",
      description: "After 4.b4, Black declines the gambit with ...Bb6 instead of taking. Punish with a4-a5 expansion.",
      branchesAt: 6,
      opponentMove: {
        san: "b4",
        color: "white",
        why: "You play the Evans Gambit, sacrificing a pawn for development.",
        concepts: ["attack"],
      },
      moves: [
        { san: "Bb6", color: "black", why: "Black declines the gambit, retreating the bishop. They keep material parity but give you queenside expansion.", concepts: ["pawn-structure"] },
        { san: "a4", color: "white", why: "Push a4 to threaten a5 kicking the bishop. The b-pawn was offered — declining means you keep the pressure.", concepts: ["space", "attack"] },
        { san: "a6", color: "black", why: "Black stops a5.", concepts: ["pawn-structure"] },
        { san: "Nc3", color: "white", why: "Develop the queen-side knight.", concepts: ["development"] },
    ...
    {
      id: "moller-attack",
      name: "Möller Attack — Black plays ...Nxe4 after Bd2",
      description: "Main line goes 7.Bd2 Bxd2+, but Black might grab the e4 pawn with ...Nxe4 instead. Sacrifice the bishop with Bxf7+ for a winning attack!",
      branchesAt: 13,
      opponentMove: {
        san: "Nxe4",
        color: "black",
        why: "Black plays the sharp ...Nxe4 grabbing the e4 pawn. This is the Möller Attack — Black hopes to keep the pawn but you have a brilliant sacrifice.",
        concepts: ["attack"],
      },
      moves: [
        {
          san: "Bxb4",
          color: "white",
          why: "Take the bishop first (it was on b4 from move 6...Bb4+). Black HAS to recapture.",
          concepts: ["piece-activity"],
        },
        { san: "Nxb4", color: "black", why: "Forced — Black takes back.", concepts: ["piece-activity"] },
        {
          san: "Bxf7+",
          color: "white",
          why: "BISHOP SACRIFICE! Bxf7+ rips open the king. Black has to take or lose huge material.",
          concepts: ["attack"],
        },
        { san: "Kxf7", color: "black", why: "Black takes — forced (Kf8 also drops material).", concepts: ["king-safety"] },
        {
          san: "Qb3+",
          color: "white",
          why: "Queen check! This forks the king and the knight on b4. Black must give up at least one.",
          concepts: ["attack"],
        },
        { san: "d5", color: "black", why: "Black blocks the check with the d-pawn.", concepts: ["pawn-structure"] },
        {
          san: "Ne5+",
          color: "white",
          why: "Knight check from the center! The attack rolls on.",
          concepts: ["attack"],
        },
        { san: "Ke6", color: "black", why: "King has to walk forward.", concepts: ["king-safety"] },
        {
          san: "Qxb4",
          color: "white",
          why: "Take the knight! You've won material AND have a vicious attack on the exposed king.",
          concepts: ["attack"],
        },
      ],
    },
    {
      id: "nxe4-after-trade",
      name: "Black grabs e4 pawn after the bishop trade",
      description: "After 7.Bd2 Bxd2+ 8.Nbxd2, Black plays ...Nxe4 grabbing the pawn. Punish with Re1 pinning to the king.",
      branchesAt: 15,
      opponentMove: {
        san: "Nxe4",
        color: "black",
        why: "Black greedily grabs the e4 pawn. The knight is exposed — punish them.",
        concepts: ["attack"],
      },
      moves: [
        { san: "O-O", color: "white", why: "Castle first to bring the rook into play. The knight on e4 isn't going anywhere — you'll punish it next.", concepts: ["king-safety"] },
        { san: "Nxd2", color: "black", why: "Black trades the knight for your queen-side knight, leaving your e-file open.", concepts: ["piece-activity"] },
        { san: "Qxd2", color: "white", why: "Recapture with the queen. You have an open e-file, active pieces, and a strong center for the pawn.", concepts: ["development"] },
        { san: "d6", color: "black", why: "Black solidifies.", concepts: ["pawn-structure"] },
      ],
    },
    {
      id: "d6-after-trade",
      name: "After bishop trade, Black plays passive ...d6",
      description: "After 7.Bd2 Bxd2+ 8.Nbxd2, Black plays the passive ...d6 instead of the freeing ...d5. Use the extra space.",
      branchesAt: 15,
      opponentMove: {
        san: "d6",
        color: "black",
        why: "Black plays a passive defense instead of the freeing ...d5 break. You keep the better center.",
        concepts: ["pawn-structure"],
      },
      moves: [
        { san: "O-O", color: "white", why: "Castle.", concepts: ["king-safety"] },
        { san: "O-O", color: "black", why: "Black castles.", concepts: ["king-safety"] },
        { san: "Re1", color: "white", why: "Activate the rook on the open e-file. You have the better position.", concepts: ["piece-activity"] },
      ],
    },
    {
      id: "modern-italian-d3",
      name: "Modern Italian (slow d3 system)",
      description: "Instead of c3+d4 (the classical line), play the modern d3 setup. Slower buildup, less theoretical, very solid.",
      branchesAt: 6,
      opponentMove: {
        san: "O-O",
        color: "white",
        why: "Castle first instead of pushing c3. The Modern Italian — slow, positional, very popular at the top level (Carlsen plays it!).",
        concepts: ["king-safety", "development"],
      },
      moves: [
        { san: "Nf6", color: "black", why: "Black develops.", concepts: ["development"] },
        { san: "d3", color: "white", why: "The hallmark of the Modern Italian — slow buildup. d3 keeps the center flexible.", concepts: ["pawn-structure"] },
        { san: "O-O", color: "black", why: "Black castles.", concepts: ["king-safety"] },
        { san: "c3", color: "white", why: "Now play c3 — but slower, after castling. This prepares Bb3 to keep the bishop active.", concepts: ["preparation"] },
        { san: "d6", color: "black", why: "Black plays d6.", concepts: ["pawn-structure"] },
        { san: "Nbd2", color: "white", why: "Develop via d2 (NOT c3 — that's where the pawn went!). The knight will reroute via f1-g3.", concepts: ["development"] },
        { san: "a6", color: "black", why: "Black makes a useful waiting move.", concepts: ["pawn-structure"] },
        { san: "Bb3", color: "white", why: "Reroute the bishop to b3 to avoid trades after Black plays Na5.", concepts: ["piece-activity"] },
      ],
    },
  ],
};
