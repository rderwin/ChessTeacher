  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        href: "/drills",
        description:
          "Face common attacks and tricky situations — queen attacks, Scholar's Mate, and more. The bot plays, you respond.",
        icon: "🎯",
    ...
    cards: [
      {
        ...
        href: "/trainer",
        description:
          "Play against bots at 8 difficulty levels while a furry coach watches every move and gives you feedback.",
        icon: "🐕",
      ...
      },
      {
        ...
        href: "/play",
        description:
          "Challenge a friend to a real-time game. Create a room and share the link.",
        icon: "🌐",
    ...
    cards: [
      {
        ...
        icon: "🔍",
        colorClass: "from-violet-600/10 to-purple-700/10 hover:border-violet-500/40",
      },
    ],
  },
];
